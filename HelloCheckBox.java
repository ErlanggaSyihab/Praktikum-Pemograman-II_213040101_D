...
public class HelloCheckBox extends JFrame {
    ...
    public HelloCheckBox() {
        ...
        textField.setBounds(15, 
 60, 250, 30);

        JCheckBox checkBox = new JCheckBox("Saya menyetujui syarat dan ketentuan yang berlaku");
        checkBox.setBounds(15, 100, 250, 30);

        JButton button = new JButton("Simpan");
        button.setBounds(15, 150, 300, 40);

        JTextArea txtOutput = new JTextArea("");
        txtOutput.setBounds(15, 200, 250, 100);

        checkBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                checkBoxSelected = e.getStateChange() 
 == ItemEvent.SELECTED;
            }
        });
